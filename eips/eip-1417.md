...
3. Allow the compatibility with token standard such as [ERC-20](https://eips.ethereum.org/EIPS/eip-20) or \([https://eips.ethereum.org/EIPS/eip-777](https://eips.ethereum.org/EIPS/eip-777)\)\) and membership standard such as [EIP-1261](https://eips.ethereum.org/EIPS/eip-1261)
...
1. The Original ERC-1417 Issue. [https://github.com/ethereum/eips/issues/1417](https://github.com/ethereum/eips/issues/1417)
...
1. ERC-1417 \(announcement of first live discussion\). [https://github.com/ethereum/eips/issues/1417](https://github.com/ethereum/eips/issues/1417)
