...
Below is table version of the above diagram. Vertical shows the _new value_ being set, and horizontal shows the state of _original value_ and _current value_.
