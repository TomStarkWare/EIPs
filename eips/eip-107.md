...
created: '2016-06-05T00:00:00.000Z'
status: Draft
...
![](../.gitbook/assets/authorization-locked.png)
...
![](../.gitbook/assets/authorization-password.png)

## Specification

In order for the mechanism to work, the node needs to serve an html file via http at the url \/authorization.html
