...
* [Table of contents](eip-1822.md#table-of-contents)
* [Simple Summary](eip-1822.md#simple-summary)
* [Abstract](eip-1822.md#abstract)
* [Motivation](eip-1822.md#motivation)
* [Terminology](eip-1822.md#terminology)
* [Specification](eip-1822.md#specification)
  * [Proxy Contract](eip-1822.md#proxy-contract)
    * [Functions](eip-1822.md#functions)
      * [`fallback`](eip-1822.md#fallback)
    * [`constructor`](eip-1822.md#constructor)
  * [Proxiable Contract](eip-1822.md#proxiable-contract)
    * [Functions](eip-1822.md#functions-1)
      * [`proxiable`](eip-1822.md#proxiable)
      * [`updateCodeAddress`](eip-1822.md#updatecodeaddress)
* [Pitfalls when using a proxy](eip-1822.md#pitfalls-when-using-a-proxy)
  * [Separating Variables from Logic](eip-1822.md#separating-variables-from-logic)
  * [Restricting dangerous functions](eip-1822.md#restricting-dangerous-functions)
* [Examples](eip-1822.md#examples)
  * [Owned](eip-1822.md#owned)
  * [ERC-20 Token](eip-1822.md#erc-20-token)
    * [Proxy Contract](eip-1822.md#proxy-contract-1)
    * [Token Logic Contract](eip-1822.md#token-logic-contract)
* [References](eip-1822.md#references)
* [Copyright](eip-1822.md#copyright)
...
The proposed fallback function follows the common pattern seen in other Proxy Contract implementations such as [Zeppelin](https://github.com/maraoz/solidity-proxy/blob/master/contracts/Dispatcher.sol) or [Gnosis](https://blog.gnosis.pm/solidity-delegateproxy-contracts-e09957d0f201).
...
> :warning: Warning: `updateCodeAddress` and `proxiable` must be present in the Logic Contract. Failure to include these may prevent upgrades, and could allow the Proxy Contract to become entirely unusable. See below [Restricting dangerous functions](eip-1822.md#restricting-dangerous-functions)
