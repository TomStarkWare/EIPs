...
status: Draft
type: Meta
created: '2015-11-17T00:00:00.000Z'
---
...
The networking layer specifies the Ethereum wire protocol \(eth\) and the Light Ethereum Subprotocol \(les\). RLPx is excluded and tracked in the \[[https://github.com/ethereum/devp2p](https://github.com/ethereum/devp2p) devp2p repository\].
